                  ...
                  <a
                    ...
                    className={`inline-flex h-10 items-center gap-2 border-b-2 px-3 text-xs font-semibold transition-colors ${
                      active
                        ...
                        : "border-transparent text-slate-600 hover:border-teal-300 hover:text-slate-950"
                    }`}
                    aria-current={active ? "page" : undefined}
                  >
                    <Icon className="h-3.5 w-3.5" aria-hidden="true" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.7fr_0.8fr]">
            ...
            <div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-x-6 gap-y-2 text-sm font-medium text-slate-200">
                {navigation.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
