        ...
        <div className="mx-auto grid max-w-7xl gap-4 px-4 sm:px-6 lg:px-8">
          {activities.map((activity, index) => (
            <Reveal key={activity.id} variant={index % 2 === 1 ? "right" : "left"}>
              <article className="motion-card grid overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm lg:grid-cols-[0.92fr_1.08fr]">
                <div
                ...
                <div className="p-5 sm:p-7">
                  <h2 className="font-display text-xl font-semibold text-slate-950">{activity.title}</h2>
